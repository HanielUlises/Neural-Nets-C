...
void matrix_vector_multiply (double *input_vector, const int INPUT_LEN, double *output_vector, const int OUTPUT_LEN, double weight_matrix[OUTPUT_LEN][INPUT_LEN]);
